<?php
/**
 * Resumen de Cuenta (Deudores) — Vista. Solo lectura.
 * Equivale al "CD Resumen de Cuenta" del legacy. Referencia: RDN/resumen.
 */
require_once __DIR__ . '/../../includes/auth.php';
require_once __DIR__ . '/../../includes/layout.php';
auth_require_login();

module_head('Resumen de Cuenta', 'bi-journal-text',
...
<style>
    ...
    .row-FV td:first-child { box-shadow: inset 3px 0 0 var(--bs-primary); }
    .row-RC td:first-child { box-shadow: inset 3px 0 0 var(--bs-success); }
...
<div class="row g-2 mb-2 stats-row" id="statsRow" style="display:none;">
    ...
    <div class="col-6 col-md-3"><div class="card stat-card"><div class="stat-icon bg-primary-subtle text-primary"><i class="bi bi-file-earmark-text"></i></div><div><div class="stat-value" id="statDebitos">$0,00</div><div class="stat-label">Débitos</div></div></div></div>
    <div class="col-6 col-md-3"><div class="card stat-card"><div class="stat-icon bg-success-subtle text-success"><i class="bi bi-receipt"></i></div><div><div class="stat-value" id="statCreditos">$0,00</div><div class="stat-label">Créditos</div></div></div></div>
...
<div class="print-header" id="printHeader">
    <div style="text-align:center;font-weight:bold;">RESUMEN DE CUENTA</div>
...
<?php module_foot('<script src="assets/js/resumen.js?v=2"></script>'); ?>
