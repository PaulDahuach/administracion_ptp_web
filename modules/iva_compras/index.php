<?php
/**
 * I.V.A. Compras — Vista. Solo lectura. Porta el "Rpt 00 IVA" (I.V.A. Compras).
 */
...
module_head('I.V.A. Compras', 'bi-percent',
...
<style>
    ...
    #grdIva tbody tr.neg { color: var(--bs-danger); }
...
<div class="row g-2 mb-2 stats-row" id="statsRow" style="display:none;">
    ...
    <div class="col-6 col-md-3"><div class="card stat-card"><div class="stat-icon bg-success-subtle text-success"><i class="bi bi-percent"></i></div><div><div class="stat-value" id="stIva">$0,00</div><div class="stat-label">I.V.A. (Créd. Fiscal)</div></div></div></div>
    <div class="col-6 col-md-3"><div class="card stat-card"><div class="stat-icon bg-warning-subtle text-warning"><i class="bi bi-receipt-cutoff"></i></div><div><div class="stat-value" id="stPercIva">$0,00</div><div class="stat-label">Percep. IVA</div></div></div></div>
    <div class="col-6 col-md-3"><div class="card stat-card"><div class="stat-icon bg-secondary-subtle text-secondary"><i class="bi bi-cash-stack"></i></div><div><div class="stat-value" id="stTotal">$0,00</div><div class="stat-label">Total</div></div></div></div>
</div>

<div class="print-header" id="printHeader">
    <div style="text-align:center;font-weight:bold;">I.V.A. COMPRAS</div>
            ...
            <table class="table table-sm table-hover mb-0" id="grdIva">
                <thead class="table-light" style="position:sticky;top:0;">
                    <tr>
                        ...
                        <th class="text-end" style="width:95px">P. IVA</th>
                ...
                <tfoot class="table-light fw-bold">
                    <tr>
                        ...
                        <td class="text-end" id="ftPercIva"></td>
...
<?php module_foot('<script src="assets/js/iva_compras.js"></script>'); ?>
