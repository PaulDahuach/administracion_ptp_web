...
<div class="fc-form" id="ndForm">
  <div class="card fc-card mb-2"><div class="card-body">
    <?php if ($capa): ?><div class="alert alert-warning py-1 px-2 small mb-2"><i class="bi bi-mortarboard me-1"></i>Modo <b>capacitación</b> (negro) — la ND se graba <b>sin CAE</b> (no fiscal).</div>
...
<script src="assets/js/nd.js?v=2"></script>
'); ?>
