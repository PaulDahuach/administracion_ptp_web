<?php
/** Listado de Zonas (Rpt CD Zonas). DENOMINACIÓN + CÓDIGO. */
require_once __DIR__ . '/../../includes/auth.php';
require_once __DIR__ . '/../../includes/db.php';
require_once __DIR__ . '/../../includes/layout.php';
auth_require_login();

$rows = db_query("SELECT DENZON, CODZON FROM [Tbl Zonas] ORDER BY DENZON;");
...
<div class="lst-doc">
  ...
  <table class="lst-tbl lst-tight cd-tbl" style="table-layout:fixed; width:19.0cm">
    ...
    <tbody>
      ...
      <tr>
        <td><?= h(trim((string) nz($r['DENZON'], ''))) ?></td>
        <td class="r mono"><?= str_pad((string) (int) $r['CODZON'], 8, '0', STR_PAD_LEFT) ?></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
