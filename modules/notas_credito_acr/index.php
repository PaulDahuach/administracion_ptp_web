<?php
/** Notas de Crédito Acreedoras — registración de la NC del proveedor (Frm CA Creditos, sin AFIP). */
require_once __DIR__ . '/../../includes/auth.php';
require_once __DIR__ . '/../../includes/layout.php';
auth_require_login();

if (db_readonly()) {
    module_head('Notas de Crédito Acreedoras', 'bi-receipt-cutoff');
...
$btnLbl = $capa ? '<i class="bi bi-mortarboard me-1"></i>Grabar NC (capacitación)' : '<i class="bi bi-save me-1"></i>Grabar nota de crédito';
...
module_head('Notas de Crédito Acreedoras', 'bi-receipt-cutoff', $toolbar);
?>
<style>
    ...
    <div class="cp-col-right">
      ...
      <div class="card fc-card mb-2">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm mb-0"><thead><tr><th>Cuenta</th><th class="cp-num" style="width:80px">Alíc.</th><th class="cp-num" style="width:170px">Debe</th></tr></thead><tbody id="impBody"></tbody></table>
        </div>
      </div>
...
<div class="modal fade" id="modalBuscarCP" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header py-2"><h6 class="modal-title mb-0"><i class="bi bi-search me-2"></i>Notas de Crédito Acreedoras emitidas</h6><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
...
<script src="assets/js/nc_acr.js?v=3"></script>
'); ?>
