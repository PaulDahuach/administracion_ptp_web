    ...
    <div class="cp-col-right">
      ...
      <div class="card fc-card mb-2">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm mb-0"><thead><tr><th>Cuenta</th><th>Centro de costo</th><th class="cp-num" style="width:64px">Alíc.</th><th class="cp-num" style="width:150px">A acreditar</th><th style="width:36px"></th></tr></thead><tbody id="impBody"></tbody></table>
        </div>
      </div>
...
<script src="assets/js/nd_acr.js?v=2"></script>
'); ?>
