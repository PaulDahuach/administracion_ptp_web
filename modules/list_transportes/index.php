<?php
/** Listado de Transportes (Rpt CD Transportes). DENOMINACIÓN + CÓDIGO. */
require_once __DIR__ . '/../../includes/auth.php';
require_once __DIR__ . '/../../includes/db.php';
require_once __DIR__ . '/../../includes/layout.php';
auth_require_login();

$rows = db_query("SELECT DENTRA, CODTRA FROM [Tbl Transportes] ORDER BY DENTRA;");
$toolbar = '<button onclick="window.print()" class="btn btn-outline-light btn-sm"><i class="bi bi-printer me-1"></i>Imprimir</button>';
module_head('Listado de Transportes', 'bi-truck', $toolbar);
?>
...
<div class="lst-doc">
  <div class="lst-head">
    ...
    <div class="lst-tit">TRANSPORTES</div>
  ...
  <table class="lst-tbl lst-tight cd-tbl" style="table-layout:fixed; width:19.0cm">
    ...
    <tbody>
      ...
      <tr>
        <td><?= h(trim((string) nz($r['DENTRA'], ''))) ?></td>
        <td class="r mono"><?= str_pad((string) (int) $r['CODTRA'], 8, '0', STR_PAD_LEFT) ?></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
