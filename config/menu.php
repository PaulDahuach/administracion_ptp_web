...
return [
    'Imputaciones Contables' => [
        ...
        ['head' => 'Listados'],
        ['label' => 'Bancos', 'desc' => 'Listado del maestro de bancos (denominación, CUIT, código) — imprimible', 'icon' => 'bi-bank', 'url' => '/modules/list_bancos/'],
        ['label' => 'Movimientos Bancarios', 'desc' => 'Ledger de una cuenta bancaria + estado de conciliación', 'icon' => 'bi-cash-stack', 'url' => '/modules/bancos/'],
        ['label' => 'Operaciones', 'desc' => 'Listado de operaciones: comprobante, auxiliares y modelos de imputación — imprimible', 'icon' => 'bi-gear-wide-connected', 'url' => '/modules/list_operaciones/'],
        ['label' => 'Cuentas Bancarias', 'desc' => 'Listado de cuentas bancarias (copias de constancia, discontinuada) — imprimible', 'icon' => 'bi-bank2', 'url' => '/modules/list_cuentas_bancarias/'],
        ['label' => 'Centros de Costo', 'desc' => 'Listado de centros de costo — imprimible', 'icon' => 'bi-diagram-3', 'url' => '/modules/list_centros/'],
    ...
    'Stock' => [
        ['head' => 'Actualizaciones'],
        ['label' => 'Rubros', 'desc' => 'Rubros + subform de Subrubros (cuentas contables compras/ventas, utilidad)', 'icon' => 'bi-tag', 'url' => '/modules/abm/?m=rubros'],
